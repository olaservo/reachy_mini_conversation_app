...
- Tap "Custom" to create a new personality by entering a name and instructions. It stores files under `profiles/<name>/` and copies `tools.txt` from the `default` profile.
