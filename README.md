...
| `OPENAI_REALTIME_SESSION_URL` | Optional session allocation URL for the deployed speech-to-speech load balancer. Set it to use the deployed backend; leave it unset to use native OpenAI Realtime directly. |
